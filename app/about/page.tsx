          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  In the mid-2010s, <span className="font-semibold text-accent-brown">Shanmugam Srinivasan</span>, a true lover of traditional South Indian cuisine,
                ...
                <p>
                  The restaurant was registered officially in <span className="font-semibold">July 2017</span>, under his proprietorship.
